...
<![endif]-->
  <!-- ============================================================== -->
    ...
    <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <h6 class="card-subtitle">
                Jika jumlah produk mulai berkurang atau kosong, harap isi data permintaan produk agar <br>
                pegawai gudang yang ada di pusat dapat mengirimkan produk tersebut ke Nice So Padalarang
              </h6>
              <button type="button" class="btn waves-effect waves-light btn-info" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i>Tambah Permintaan Produk</button>
                <br> <br>
                ...
                foreach($permintaanproduk as $row):?>
                    <tr>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn btn-outline-danger btn-sm btn-delete" data-toggle="modal" data-target="#deleteModal" data-id="<?= $row->permintaan_id;?>"> <li class="fa fa-trash"></li> Hapus</button>
                        </td>
                    </tr>
                <?php endforeach;?>
                </tbody>
        ...
        <!-- Modal Add Product-->
        <form action="/permintaanproduk/simpan" method="post">
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Permintaan Produk </h5>
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label>Tanggal</label>
                      <input type="date" class="form-control" name="permintaan_tanggal">
                  </div>

                    <div class="form-group">
                        <label>Produk</label>
                        <select name="permintaan_produk" class="form-control">
                    ...
                    <div class="form-group">
                        <label>Jumlah</label>
                        <input type="number" class="form-control" name="permintaan_jumlah">
                    </div>

                    <div class="form-group">
                        <label>Status</label>
                        <select name="permintaan_status" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="permintaan_deskripsi" class="form-control" rows="8" cols="80"></textarea>
                    </div>
        ...
        <!-- Modal Edit Product-->
        <form action="/permintaanproduk/update" method="post">
        ...
        <form action="/permintaanproduk/hapus" method="post">
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Hapus Permintaan produk</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <h4>Apakah kamu yakin untuk menghapus permintaan produk ini?</h4>

                </div>
                <div class="modal-footer">
                    <input type="hidden" name="permintaan_id" class="productID">
