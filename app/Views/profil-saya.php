                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="mt-4"> <img src="../../assets/images/users/5.jpg" class="rounded-circle" width="150" />
                                    ...
                                    <h6 class="card-subtitle"><?= session()->get('priviledge') ?></h6>
                            ...
                            <div class="card-body"> <small class="text-muted">Alamat Email </small>
                                <h6><?= session()->get('name') ?></h6> <small class="text-muted pt-4 db">No. Telepon</small>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#last-month" role="tab" aria-controls="pills-profile" aria-selected="false">Profil</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>No. Telepon</strong>
                                                <br>
                                                <p class="text-muted"><?= session()->get('telepon') ?></p>
                                            </div>
